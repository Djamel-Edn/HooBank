...
const Business = () => {
  return (
    <section id='Business' className='flex flex-col md:flex-row text-white py-4 md:py-20 gap-4  lg:mx-[160px]  px-1 '>
        ...
        <img src={card} alt="card" className='w-full object-contain mr-5' />
        </div>
    </section>
  )
}
